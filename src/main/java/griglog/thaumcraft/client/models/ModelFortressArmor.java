...
import griglog.thaumcraft.items.armor.FortressArmor;
...
public class ModelFortressArmor extends BipedModel<LivingEntity> {
    public boolean hasGoggles;
    public int pieces, mask;
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        bipedHeadwear.showModel = false;
        Goggles.showModel = hasGoggles;
        for (int a = 0; a < 3; ++a) {
            Mask[a].showModel = (mask == a);
        }
        Scroll.showModel = (pieces >= 3);
        Book.showModel = (pieces >= 2);
        OrnamentL.showModel = (pieces >= 3);
        OrnamentL2.showModel = (pieces >= 3);
        OrnamentR.showModel = (pieces >= 3);
        OrnamentR2.showModel = (pieces >= 3);
        Gemornament.showModel = (pieces >= 3);
        Gem.showModel = (pieces >= 3);
        flapL.showModel = (pieces >= 2);
        flapR.showModel = (pieces >= 2);
        ShoulderplateLtop.showModel = (pieces >= 2);
        ShoulderplateL1.showModel = (pieces >= 2);
        ShoulderplateL2.showModel = (pieces >= 3);
        ShoulderplateL3.showModel = (pieces >= 3);
        ShoulderplateRtop.showModel = (pieces >= 2);
        ShoulderplateR1.showModel = (pieces >= 2);
        ShoulderplateR2.showModel = (pieces >= 3);
        ShoulderplateR3.showModel = (pieces >= 3);
        SidepanelR2.showModel = (pieces >= 2);
        SidepanelL2.showModel = (pieces >= 2);
        SidepanelR3.showModel = (pieces >= 3);
        SidepanelL3.showModel = (pieces >= 3);
