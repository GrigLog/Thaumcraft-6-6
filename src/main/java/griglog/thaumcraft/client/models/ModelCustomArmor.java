...
public class ModelCustomArmor {} /*extends BipedModel<LivingEntity>{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        if (entityIn instanceof LivingEntity) {
            swingProgress = ((LivingEntity) entityIn).getSwingProgress(UtilsFX.sysPartialTicks);
        }
        if (entityIn instanceof ArmorStandEntity) {
            setRotationAnglesStand(limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scaleFactor, entityIn);
        } else if (entityIn instanceof SkeletonEntity || entityIn instanceof ZombieEntity) {
    ...
    public void setRotationAnglesZombie(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        boolean flag = entityIn instanceof ZombieEntity && ((ZombieEntity) entityIn).isArmsRaised();
